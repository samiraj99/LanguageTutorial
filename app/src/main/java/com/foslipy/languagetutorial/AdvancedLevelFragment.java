...
public class AdvancedLevelFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        CH4 = view.findViewById(R.id.CardView_Advanced_chapter_4);
        CH5 = view.findViewById(R.id.CardView_Advanced_chapter_5);
        CH6 = view.findViewById(R.id.CardView_Advanced_chapter_6);
        CH7 = view.findViewById(R.id.CardView_Advanced_chapter_7);
        CH8 = view.findViewById(R.id.CardView_Advanced_chapter_8);
        CH9 = view.findViewById(R.id.CardView_Advanced_chapter_9);
